        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-left mr-auto ml-3 pl-1">
                ...
                <li class="nav-item dropdown">
                    <?php
                    $sql = "SELECT * from  guests where Status is null ";
                    
                    $query = $dbh->prepare($sql);
                    $query->execute();
                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                    $totnewguests = $query->rowCount();
                    ?>
                    <a class="nav-link dropdown-toggle pl-md-3 position-relative" href="javascript:void(0)" id="bell"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span><i data-feather="bell" class="svg-icon"></i></span>
                        <span
                            class="badge badge-primary notify-no rounded-circle"><?php echo htmlentities($totnewguests); ?></span>
                    </a>
                                    ...
                                    foreach ($results as $row) {
                                        ...
                                        <a href="new-order.php"
                                            ...
                                            <div class="w-75 d-inline-block v-middle pl-2">
                                                <h6 class="message-title mb-0 mt-1">New Guest Application</h6>
                                                <span
                                                    class="font-12 text-nowrap d-block text-muted"><?php echo $row->name; ?></span>
                                                <!-- <span
                                                    class="font-12 text-nowrap d-block text-muted"><?php echo $row->checkin; ?></span> -->
                                            </div>
                                        </a>
                                        <!-- Message -->
                                    <?php } ?>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <img src="assets/images/users/images.png" alt="user" class="rounded-circle" width="40">
                        <?php
