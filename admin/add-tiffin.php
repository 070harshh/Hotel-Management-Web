...
$image=md5($image).time().$extension;
 move_uploaded_file($_FILES["image"]["tmp_name"],"image/".$image);
  $sql="insert into tbltiffin(Type,Title,Description,Cost,Image)values(:type,:title,:desc,:cost,:image)";
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <input type="file" class="form-control" id="" name="image" value="" required="true">
                                                        </div>
                                                    </div>
