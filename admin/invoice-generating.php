...
if (strlen($_SESSION['otssaid'] == 0)) {
  ...
  <head>
    ...
    <title>The Royal Orchid-Invoice</title>
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-7 align-self-center">
              <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Invoice of Stay</h4>
              <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb m-0 p-0">
                    <li class="breadcrumb-item"><a href="dashboard.php" class="text-muted">Home</a></li>
                    <li class="breadcrumb-item text-muted active" aria-current="page">Invoice of Stay</li>
                  </ol>
                </nav>
              </div>
            </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Invoice of Stay</h4>
                    ...
                    if ($query->rowCount() > 0) {
                      foreach ($results as $row) { ?>
                        <table border="1"
                          ...
                          <tr>
                            <th colspan="5" style="text-align: center;color: red;font-size: 20px">Invoice Number:
                              <?php echo $row->booking_id; ?></th>
                          </tr>
                          ...
                          <tr>
                            ...
                            <th>Order Date</th>
                            <td colspan="2"><?php echo $row->checkin; ?></td>
                          </tr>
                          <!-- <tr>
                            <th>Tiffin Title</th>
                            <td><?php echo $row->Title; ?></td>
                            <th>Tiffin Image</th>
                            <td colspan="2"><img src="images/<?php echo $row->Image; ?>" width="200" height="150"
                          ...
                          <tr>
                            ...
                            <th>To Date</th>
                            <td colspan="2"><?php echo $row->checkout; ?></td>
                          </tr>
                          <table border="1"
                            class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                            <tr>
