        ...
        <!-- <div class="nav-controls"> -->
            <div class="flex space-x-6">
                <div class="relative dropdown">
                    <button a class="text-white-600 hover:text-white-800 focus:outline-none">Destinations</button a>
                    <div class="absolute left-0 mt-2 w-64 bg-black shadow-md rounded-md py-2 z-20 dropdown-menu hidden">
            ...
            <a href="room_details.php">Room Tariffs</a>
            <a href="room_details.php">Book Room</a>
